 ...
 */
@Entity
@Table(name = "item_impressao_aux")
public class ItemImpressaoAux implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemImpressaoAux)) {
            return false;
        }
        ItemImpressaoAux other = (ItemImpressaoAux) object;
